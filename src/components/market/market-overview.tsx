          ...
          <tbody>
            {quotes.map((q) => {
              ...
              return (
                <tr
                  key={q.asset}
                  className="border-b border-tv-divider transition-colors hover:bg-tv-elevated"
                >
                  ...
                  <td className="py-1.5 text-right tabular-nums text-tv-secondary">
                    {q.volume > 0
